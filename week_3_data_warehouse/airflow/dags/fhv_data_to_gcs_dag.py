...
# dataset_file = "fhv_tripdata_2021-01.csv"
...
def change_dtype(local_file):
    ...
    df_raw = raw_table.to_pandas(timestamp_as_object=True)

    df_raw['pickup_datetime'] = pd.to_datetime(df_raw['pickup_datetime'], errors='coerce')
    df_raw['dropOff_datetime'] = pd.to_datetime(df_raw['dropOff_datetime'], errors='coerce')
...
with DAG(
    dag_id="fhv_tripdata_to_gcs_dag",
